...
<div class="rounded-3xl border-2 border-success bg-success p-6 space-y-5">
	...
	<div class="grid grid-cols-2 gap-2">
		<button onclick={shareWhatsApp}
			class="flex items-center justify-center gap-2 rounded-full bg-[#25D366] border-2 border-[#25D366] px-4 py-3 text-sm font-medium text-white hover:opacity-90 transition-all">
