...
<div class="rounded-3xl border-2 border-border bg-card p-5">
	...
	<textarea
		...
		class="mt-2 w-full rounded-xl border-2 border-input bg-background px-4 py-3 text-sm font-mono h-20 resize-none focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all"
		spellcheck="false"
	></textarea>
