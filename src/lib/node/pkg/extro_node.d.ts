...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_530_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_530_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_530_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_530_5: (a: number, b: number, c: number) => void;
