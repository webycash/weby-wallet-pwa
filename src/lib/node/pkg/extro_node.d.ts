...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2655: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2662: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_761: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_761_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_761_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_761_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_761_5: (a: number, b: number, c: number) => void;
