...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2651: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2666: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_500: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_500_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_500_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_500_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_500_5: (a: number, b: number, c: number) => void;
