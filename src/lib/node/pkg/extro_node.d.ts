...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2701: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2716: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_524: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_524_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_524_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_524_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_524_5: (a: number, b: number, c: number) => void;
