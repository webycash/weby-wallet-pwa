...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2562: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2569: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_733: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_733_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_733_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_733_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_733_5: (a: number, b: number, c: number) => void;
