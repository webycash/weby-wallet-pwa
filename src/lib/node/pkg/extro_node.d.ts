...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2560: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2567: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_731: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_731_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_731_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_731_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_731_5: (a: number, b: number, c: number) => void;
